...
void SDCard::pausePrint(bool intern)
{
    ...
    if(intern) {
        ...
        Printer::moveToReal(0,0,((Printer::currentPosition[Z_AXIS] + 2) < Z_MAX_LENGTH)?(Printer::currentPosition[Z_AXIS] + 2):IGNORE_COORDINATE,IGNORE_COORDINATE,0.5*Printer::maxFeedrate[Z_AXIS]);
#else
