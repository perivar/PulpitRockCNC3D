...
*/
  ...
  */
  ...
  #define UI_NUM_PAGES 1+UI_PRINTTIME_COUNT
 ...
 #if HAVE_HEATED_BED==true
 #if NUM_EXTRUDER>0
   UI_PAGE4(ui_page1,cTEMP "%ec/%Ec" cDEG cBED "%eB/%Eb" cDEG,"Z:%x2  Buf:%oB","Mul: %om   Flow: %of","%os");
#else
   UI_PAGE4(ui_page1,cBED "%eB/%Eb" cDEG,"Z:%x2  Buf:%oB","Mul: %om   Flow: %of","%os");
#endif
   ...
   UI_PAGE4(ui_page1,cTEMP "%ec/%Ec" cDEG,"Z:%x2  Buf:%oB","Mul: %om   Flow: %of","%os");
   #else
...
#endif
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_all,UI_TEXT_HOME_ALL,UI_ACTION_HOME_ALL,0,MENU_MODE_PRINTING2);
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_x,UI_TEXT_HOME_X,UI_ACTION_HOME_X,0,MENU_MODE_PRINTING2);
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_y,UI_TEXT_HOME_Y,UI_ACTION_HOME_Y,0,MENU_MODE_PRINTING2);
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_home_z,UI_TEXT_HOME_Z,UI_ACTION_HOME_Z,0,MENU_MODE_PRINTING2);
...
UI_MENU_ACTIONCOMMAND(ui_menu_goto_p1,UI_TEXT_GOTO_P1,UI_ACTION_GOTO_P1);
UI_MENU_ACTIONCOMMAND(ui_menu_goto_p2,UI_TEXT_GOTO_P2,UI_ACTION_GOTO_P2);
UI_MENU_ACTIONCOMMAND(ui_menu_goto_p3,UI_TEXT_GOTO_P3,UI_ACTION_GOTO_P3);
UI_MENU_ACTIONCOMMAND(ui_menu_goto_p4,UI_TEXT_GOTO_P4,UI_ACTION_GOTO_P4);
#define UI_MENU_AUXLEVEL {UI_MENU_ADDCONDBACK &ui_menu_home_all,&ui_menu_goto_p1,&ui_menu_goto_p2,&ui_menu_goto_p3, &ui_menu_goto_p4, &ui_menu_go_zpos}
UI_MENU(ui_menu_auxlevel,UI_MENU_AUXLEVEL,6+UI_MENU_BACKCNT);
#endif
...
UI_MENU_ACTIONCOMMAND(ui_menu_bed_leveling,UI_TEXT_BED_LEVELING,UI_ACTION_BED_LEVELING);
#define BEDLEVEL_CNT 1
#define BEDLEVEL_ENTRY ,&ui_menu_bed_leveling
#else
#define	BEDLEVEL_CNT 0
#define BEDLEVEL_ENTRY
#endif
...
UI_MENU_ACTIONCOMMAND_FILTER(ui_menu_quick_stopstepper,UI_TEXT_DISABLE_STEPPER,UI_ACTION_DISABLE_STEPPER,0,MENU_MODE_PRINTING2);
...
#if FEATUER_LOAD_FILAMENT
UI_MENU_ACTIONCOMMAND(ui_menu_loadfilament,UI_TEXT_LOAD_FILAMENT,UI_ACTION_LOAD_FILAMENT);
UI_MENU_ACTIONCOMMAND(ui_menu_unloadfilament,UI_TEXT_UNLOAD_FILAMENT,UI_ACTION_UNLOAD_FILAMENT);
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BEDLEVEL_ENTRY BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY ,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_loadfilament, &ui_menu_unloadfilament, &ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick,UI_MENU_QUICK,10+BEDLEVEL_CNT+BABY_CNT+UI_MENU_BACKCNT+MENU_PSON_COUNT+DEBUG_PRINT_COUNT+UI_TOGGLE_LIGHT_COUNT);
#else
#define UI_MENU_QUICK {UI_MENU_ADDCONDBACK &ui_menu_home_all BEDLEVEL_ENTRY BABY_ENTRY ,&ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply UI_TOOGLE_LIGHT_ENTRY ,&ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs,&ui_menu_loadfilament, &ui_menu_unloadfilament, &ui_menu_quick_cooldown,&ui_menu_quick_origin,&ui_menu_quick_stopstepper MENU_PSON_ENTRY DEBUG_PRINT_EXTRA}
UI_MENU(ui_menu_quick,UI_MENU_QUICK,8+BEDLEVEL_CNT+BABY_CNT+UI_MENU_BACKCNT+MENU_PSON_COUNT+DEBUG_PRINT_COUNT+UI_TOGGLE_LIGHT_COUNT);
#endif
...
#ifdef AUXILIARY_LEVELING
#define UI_MENU_AUX_LEVEL ,&ui_menu_conf_auxlevel
#define UI_MENU_AUXLEVEL_CNT 1
UI_MENU_SUBMENU(ui_menu_conf_auxlevel, UI_TEXT_AUX_LEVEL, ui_menu_auxlevel);
#else
#define UI_MENU_AUX_LEVEL
#define UI_MENU_AUXLEVEL_CNT 0
#endif

#define UI_MENU_CONFIGURATION {UI_MENU_ADDCONDBACK &ui_menu_conf_general,&ui_menu_conf_accel,&ui_menu_conf_feed,&ui_menu_conf_extr UI_MENU_EEPROM_COND UI_MENU_DELTA_COND UI_MENU_AUX_LEVEL UI_MENU_SL_COND}
UI_MENU(ui_menu_configuration,UI_MENU_CONFIGURATION,UI_MENU_BACKCNT+UI_MENU_EEPROM_CNT+UI_MENU_DELTA_CNT+UI_MENU_AUXLEVEL_CNT+UI_MENU_SL_CNT+4);
// Main menu
