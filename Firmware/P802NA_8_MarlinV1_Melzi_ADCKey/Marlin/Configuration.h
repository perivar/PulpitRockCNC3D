...
#define EPR_MAGIC_ID			108///N=8

// Define this to set a custom name for your generic Mendel,
#define CUSTOM_MENDEL_NAME  	"P802NA_8"
#define	MACHINE_FW_VERSION		"P802NA_V1.9"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 		-45//-29
...
// default settings
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,	80, 400,90}  				// default steps per unit for P802
