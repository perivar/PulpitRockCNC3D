...
FSTRINGVALUE(Com::tZAuxLevelGotoP1Script,AUX_LEVEL_GOTOP1_SCRIPT);
FSTRINGVALUE(Com::tZAuxLevelGotoP2Script,AUX_LEVEL_GOTOP2_SCRIPT);
FSTRINGVALUE(Com::tZAuxLevelGotoP3Script,AUX_LEVEL_GOTOP3_SCRIPT);
FSTRINGVALUE(Com::tZAuxLevelGotoP4Script,AUX_LEVEL_GOTOP4_SCRIPT);
#endif
