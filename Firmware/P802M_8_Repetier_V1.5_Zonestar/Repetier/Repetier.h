...
#define BED_SENSOR_INDEX EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+KEYPAD_ANALOG_INPUTS
...
#define ANALOG_INPUTS (EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+KEYPAD_ANALOG_INPUTS+BED_ANALOG_INPUTS)
#if ANALOG_INPUTS>0
/** Channels are the MUX-part of ADMUX register */
#define  ANALOG_INPUT_CHANNELS {EXT0_ANALOG_CHANNEL EXT1_ANALOG_CHANNEL EXT2_ANALOG_CHANNEL EXT3_ANALOG_CHANNEL EXT4_ANALOG_CHANNEL EXT5_ANALOG_CHANNEL KEYPAD_ANALOG_CHANNEL BED_ANALOG_CHANNEL }
#endif

#define MENU_MODE_SD_MOUNTED 	0x01///1
#define MENU_MODE_SD_PRINTING 	0x02///2
#define MENU_MODE_SD_PAUSED 	0x04///4
#define MENU_MODE_FAN_RUNNING 	0x08///8
#define MENU_MODE_PRINTING 		0x10///16
#define MENU_MODE_PRINTING2 	0x20///32
